...
public class Parent_JFrame {
    ...
    public Parent_JFrame() {
        MainFrame = new JFrame("Kiya Car System");
            ...
            switch (e.getActionCommand()) {
                ...
                case "View JavaDoc": {
                    if (Desktop.isDesktopSupported()) {
                        try {
                            File myFile = new File("javaDoc.pdf");
                            if (myFile.exists()) {
                ...
                case "View Documentation": {
                    if (Desktop.isDesktopSupported()) {
                        try {
                            File myFile = new File("javaDocumenation.pdf");
                            if (myFile.exists()) {
                                Desktop.getDesktop().open(myFile);
                            } else {
                                JOptionPane.showMessageDialog(null, "JavaDoc not found !");
                ...
                break;
                case "About": {
                    JOptionPane.showMessageDialog(null, "OOP Java Project Dedicated to Haramaya Univerisity");
                }
                break;
